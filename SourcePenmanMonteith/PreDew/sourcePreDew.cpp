...
{
  int i, k, n, maxIndex;
  double lakePer, glacPer, glacSurfElev, glacIceThick, areaCorr[maximumNumberLandClasses], totalArea, tempArea, areaFraction[numberLandSurfaceClasses-1];
  ...
  for (i=0; i<nRows*nCols; i++) {
	...
	areaCorr[2]=areaFraction[2]+areaFraction[2]*(100.0-totalArea)/(areaFraction[0]+areaFraction[1]+areaFraction[2]);
      ...
      landScapeOut.width(15); landScapeOut << Dew[i].GetLatitude() << "  ";
      landScapeOut.precision(4); 
      landScapeOut.width(10); landScapeOut << Dew[i].GetElevation() << "  ";
      landScapeOut.width(10); landScapeOut << Dew[i].GetT1() << "  ";
      ...
      landScapeOut.width(10); landScapeOut << Dew[i].GetPcorr() << "  ";
