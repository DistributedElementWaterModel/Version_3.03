...
void HBV::WaterBalance(int timeStep, DateTime datetime, double waterInput, double temp, double snowCoverFraction, double dryPeriod, double upLandAccumulatedLowerDischarge, double upLandAccumulatedUpperDischarge)
{
