...
// Algorithm to be performed in case: input to landscape element from upstream elements
void DistributedElement::WaterBalance(int timeStep, DateTime datetime, int initialTimeSteps, int numberTimeSteps, double upLandAccumulatedLowerDischarge, double upLandAccumulatedUpperDischarge) const
{
    ...
    if (GetLake())
    {
        GetLake()->WaterBalance(timeStep, datetime, upLandAccumulatedLowerDischarge + upLandAccumulatedUpperDischarge);
    }
    if (GetGlacier())
    {
        GetGlacier()->WaterBalance(timeStep, datetime, initialTimeSteps, numberTimeSteps, upLandAccumulatedLowerDischarge, upLandAccumulatedUpperDischarge);
    }
    if (GetHbvAquifer())
    {
        ...
        while (lastHbvAquifer)
        {
            ...
            // Algorithm to be performed in case: input to landscape element from upstream elements
            lastHbvAquifer->WaterBalance(timeStep, datetime, upLandAccumulatedLowerDischarge, upLandAccumulatedUpperDischarge);
    ...
    if (GetKwaAquifer())
    {
        ...
        {
            lastKwaAquifer->WaterBalance(timeStep, datetime, upLandAccumulatedLowerDischarge, upLandAccumulatedUpperDischarge);
