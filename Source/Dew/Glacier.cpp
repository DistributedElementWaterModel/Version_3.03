...
void Glacier::WaterBalance(int timeStep, DateTime datetime, int initialTimeSteps, int numberTimeSteps, double upLandAccumulatedLowerDischarge, double upLandAccumulatedUpperDischarge)
{
    ...
    {
        GetVegetation()->WaterBalance(timeStep, datetime, GetGlacierIce()->GetPrecipitation(), GetGlacierIce()->GetTemperature());
    ...
    if (GetHBV())
    {
        ...
        GetHBV()->WaterBalance(timeStep, datetime, GetGlacierIce()->GetIceMelt()*GetGlacierIceAreaFraction() / GetAreaFraction() * (1.0 - GetSnow()->GetSnowCoverFraction()) + GetSnow()->GetWaterOutput(), GetGlacierIce()->GetTemperature(), snowIceCoverFraction, dryPeriod, upLandAccumulatedLowerDischarge, upLandAccumulatedUpperDischarge);
    }
    if (GetKinematicWave())
    {
