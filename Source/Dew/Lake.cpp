...
void Lake::WaterBalance(int timeStep, DateTime datetime, double upLandAccumulatedDischarge)
{
    //  GetAlbedoElement()->SurfaceAlbedo(this, 0, 0, 0);
    GetLakeWaterBalance()->WaterBalance(timeStep, datetime, upLandAccumulatedDischarge);
}
