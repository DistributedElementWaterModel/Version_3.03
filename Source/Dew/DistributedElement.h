...
public:
    ...
    void WaterBalance(int timeStep, DateTime datetime, int initialTimeSteps, int numberTimeSteps, double upLandAccumulatedLowerDischarge, double upLandAccumulatedUpperDischarge) const;
